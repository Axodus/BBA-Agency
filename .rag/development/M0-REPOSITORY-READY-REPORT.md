...
| REQ-IMP-000-013 | DONE | `.rag/adr/README.md` and template |
...
- `.rag/development/` local Development controls and M0 evidence;
- `.rag/adr/` index, template, and six implementation ADRs;
