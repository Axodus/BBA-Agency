...
| `.rag/development/` | Local implementation controls, source index, evidence, and M0 reports. |
| `.rag/adr/` | Local durable technical decisions; not a replacement for domain ADRs. |
