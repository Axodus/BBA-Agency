...
| --- | --- | --- | --- | --- | --- | --- |
| REQ-IMP-000-001 | BBA-STD-001 | Repository evidence | `.rag/development/repository-baseline.md` | M0 review | — | DONE |
| REQ-IMP-000-002 | BBA-POL-001 | Executable boundaries | `.rag/development/repository-boundaries.md` | `core/test/architecture/core-isolation.test.ts` | ADR-IMP-0001 | DONE |
...
| REQ-IMP-000-006 | BBA-GDE-080 | Demo non-regression | `.rag/development/demo-regression-contract.md` | demo syntax/data checks | — | DONE |
| REQ-IMP-000-007 | BBA-ADR-0001 | Documentation authority | `.rag/development/source-index.md` | source availability review | — | DONE |
| REQ-IMP-000-008 | BBAPLT-DEV-001 | Development governance | `.rag/development/development-constitution.md` | document review | — | DONE |
| REQ-IMP-000-009 | BBA-STD-002 | Readiness gate | `.rag/development/definition-of-ready.md` | checklist review | — | DONE |
| REQ-IMP-000-010 | BBA-STD-002 | Completion evidence | `.rag/development/definition-of-done.md` | M0 report | — | DONE |
| REQ-IMP-000-011 | BBA-STD-001 | Bidirectional traceability | this matrix | M0 report | — | DONE |
| REQ-IMP-000-012 | GDE-085 | Error and validation clarity | `.rag/development/error-and-validation-taxonomy.md` | Core quality checks | — | DONE |
| REQ-IMP-000-013 | GDE-079 | ADR governance | `.rag/adr/` | ADR review | — | DONE |
...
| REQ-IMP-000-022 | BBA-STD-001/002 | M0 decision evidence | `.rag/development/M0-REPOSITORY-READY-REPORT.md` | validation table | — | DONE |
...
| REQ-IMP-011-056 | GDE-079 | Persistence documentation | `.rag/development/contracts/` | document review | ADR-IMP-0034..36 | DONE |
| REQ-IMP-011-057 | GDE-079 | Persistence ADRs | `.rag/adr/ADR-IMP-0034..36` | ADR review | ADR-IMP-0034..36 | DONE |
...
| REQ-IMP-005-050 | GDE-079 | Durable Asset decisions | `.rag/adr/ADR-IMP-0016..0018` | ADR review | ADR-IMP-0016/17/18 | DONE |
...
| REQ-IMP-006-051 | GDE-079 | Durable Knowledge/Policy ADRs | `.rag/adr/ADR-IMP-0019..0021` | ADR review | ADR-IMP-0019/20/21 | DONE |
