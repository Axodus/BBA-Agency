...
### Arquivo de Schemas
[contracts/schemas.ts](../../src/contracts/schemas.ts)

### Arquivo de Permissions
[config/permissions.ts](../../src/config/permissions.ts)

### Arquivo Base do Agente
[agents/base.agent.ts](../../src/agents/base.agent.ts)

### Sistema de Memória
[memory/memory.manager.ts](../../src/memory/memory.manager.ts)

### Primeiro Agente Implementado
[agents/strategy/brief-interpreter.agent.ts](../../src/agents/strategy/brief-interpreter.agent.ts)

### Test Suite Exemplo
[utils/test-brief-interpreter.ts](../../src/utils/test-brief-interpreter.ts)
