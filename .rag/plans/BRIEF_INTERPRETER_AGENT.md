...
- **Base Class**: [agents/base.agent.ts](../../src/agents/base.agent.ts)
- **Schema Validation**: [contracts/schemas.ts](../../src/contracts/schemas.ts) → `BriefOutputSchema`
- **Permissions**: [config/permissions.ts](../../src/config/permissions.ts) → `BriefInterpreter` entry
- **Memory Integration**: [memory/memory.manager.ts](../../src/memory/memory.manager.ts)
- **Test**: [utils/test-brief-interpreter.ts](../../src/utils/test-brief-interpreter.ts)
