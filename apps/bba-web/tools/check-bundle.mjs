...
for (const entry of entries) {
  ...
  const source = content.toString("utf8"); if (/["']node:|__vite-browser-external|@bba\/platform-core|@bba\/http-transport|PRIVATE KEY|VITE_BBA_DEV_ACCESS_TOKEN/u.test(source)) throw new Error(`Forbidden bundle content in ${entry.name}`);
}
