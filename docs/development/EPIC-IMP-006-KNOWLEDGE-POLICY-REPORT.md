...
- `docs/adr/ADR-IMP-0019-KNOWLEDGE-CANONICAL-MODEL.md`
- `docs/adr/ADR-IMP-0020-POLICY-VERSIONING.md`
- `docs/adr/ADR-IMP-0021-KNOWLEDGE-REFERENCE-MODEL.md`
- `docs/development/contracts/KnowledgeAggregate.md`
- `docs/development/contracts/PolicyAggregate.md`
- `docs/development/contracts/KnowledgePolicyContext.md`
