...
- `docs/adr/ADR-IMP-0022-WORKFLOW-CANONICAL-MODEL.md`
- `docs/adr/ADR-IMP-0023-WORKFLOW-EXECUTION-SEPARATION.md`
- `docs/adr/ADR-IMP-0024-DEPENDENCY-GRAPH-VALIDATION.md`
- `docs/development/contracts/WorkflowAggregate.md`
- `docs/development/contracts/WorkflowExecution.md`
- `docs/development/contracts/Stage.md`
- `docs/development/contracts/Task.md`
- `docs/development/contracts/WorkflowContext.md`
