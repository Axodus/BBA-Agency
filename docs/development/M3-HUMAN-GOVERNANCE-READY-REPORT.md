...
- `docs/development/BOUNDED-CONTEXT-MAP.md`
- `docs/development/contracts/{Governance,Authority,Decision}Aggregate.md`
- `docs/adr/ADR-IMP-0010-GOVERNANCE-MISSION-BOUNDARY.md`
- `docs/adr/ADR-IMP-0011-GOVERNANCE-LIFECYCLE-AND-ASSIGNMENT-OWNERSHIP.md`
