...
| `docs/development/` | `CORE_TARGET` | Local implementation governance and traceability records. |
| `docs/adr/` | `CORE_TARGET` | Local durable implementation decisions. |
| `.instructions/` | `REVIEW_REQUIRED` | Historical/recovery instruction surface; not the certified BBA Platform corpus. |
| `plans/` | `LEGACY` | Historical implementation plans and status reports; not architectural authority. |
